...
export default function Footer() {
  return (
    <footer
      className="px-6 py-8 md:py-10 mt-20"
      style={{ backgroundColor: "#0A1A3A", color: "#FFFFFF" }}
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
        
        {/* Nombre */}
        <div>
          <h2 className="text-2xl font-noto tracking-[0.15em] uppercase" style={{ color: "#FFFFFF" }}>
            Cuatro y 10
          </h2>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <a href="#quienes-somos" className="transition-colors" style={{ color: "#FFFFFF" }}>
                Nosotros
              </a>
            </li>
            <li>
              <a href="#contacto" className="transition-colors" style={{ color: "#FFFFFF" }}>
                Contacto
              </a>
            </li>
          </ul>
